package com.github.dfengwei.apidoc.controller.client.system;
...
public class UserController {
     ...
     * @apiAddr {GET} {POST} /api/client/system/user/get
     *
     ...
     * @apiAddr {GET} {POST} /api/client/system/user/list
     *
     * @apiHeader {String} token Token
     *
     * @apiParam {String} [id] 用户id
     ...
     * @apiAddr {GET} {POST} /api/client/system/user/create
     *
     * @apiHeader {String} token Token
     *
     ...
     * @apiAddr {GET} {POST} /api/client/system/user/update
     *
     * @apiHeader {String} token Token
     *
     * @apiParam {String} id 用户id
     ...
     * @apiAddr {GET} {POST} /api/client/system/user/delete
     *
     * @apiHeader {String} token Token
     *
