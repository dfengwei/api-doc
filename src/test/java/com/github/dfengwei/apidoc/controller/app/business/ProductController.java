...
public class ProductController {
     ...
     * @apiAddr {GET} {POST} /api/app/business/product/get
     *
     ...
     * @apiAddr {GET} {POST} /api/app/business/product/list
     *
     * @apiHeader {String} token Token
     *
     * @apiParam {String} [id] 产品id
     ...
     * @apiAddr {GET} {POST} /api/app/business/product/create
     *
     * @apiHeader {String} token Token
     *
     ...
     * @apiAddr {GET} {POST} /api/app/business/product/update
     *
     * @apiHeader {String} token Token
     *
     * @apiParam {String} id 产品id
     ...
     * @apiAddr {GET} {POST} /api/app/business/product/delete
     *
     * @apiHeader {String} token Token
     *
