package com.github.dfengwei.apidoc.controller.web.business;
...
public class ProductController {
     ...
     * @apiAddr {GET} {POST} /api/web/business/product/get
     *
     ...
     * @apiAddr {GET} {POST} /api/web/business/product/list
     *
     * @apiHeader {String} token Token
     *
     * @apiParam {String} [id] 产品id
     ...
     * @apiAddr {GET} {POST} /api/web/business/product/create
     *
     * @apiHeader {String} token Token
     *
     ...
     * @apiAddr {GET} {POST} /api/web/business/product/update
     *
     * @apiHeader {String} token Token
     *
     * @apiParam {String} id 产品id
     ...
     * @apiAddr {GET} {POST} /api/web/business/product/delete
     *
     * @apiHeader {String} token Token
     *
